...
Ce n’est pas un problème, au contraire. Le serveur est structuré mais accessible. Commencez par le [lexique](../roleplay/lexique.md), jouez un personnage simple, et posez vos questions par ticket : personne ne vous en voudra de demander.

## Le Club NLS

Ajoutez **[NLS]** à votre pseudo sur le Discord principal : le rôle **Tag NLS** vous est attribué automatiquement et ouvre la catégorie **Club NLS** (salon exclusif, avantages, accès anticipés). Formes acceptées : `[NLS]` ou `NLS`, sans tenir compte des majuscules. Retirez le tag et l’accès disparaît ; remettez-le et vous le retrouvez.
